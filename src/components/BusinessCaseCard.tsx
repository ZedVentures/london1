        ...
        <div className="space-y-4 sm:space-y-6 mt-6 lg:mt-0">
          ...
          <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-xl sm:rounded-2xl">
            ...
            <div className="mb-3 sm:mb-4 lg:mb-6">
              <div className="flex items-end justify-center gap-0.5 xs:gap-1 sm:gap-2 h-40 sm:h-48 md:h-56 lg:h-72 bg-white p-2 sm:p-3 lg:p-4 rounded-xl border-2 border-gray-100">
